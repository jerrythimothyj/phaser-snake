export default class Snake {
    constructor(scene) {
        ...
        this.body = [];
        this.body.push(this.scene.add.rectangle(this.tileSize * 2, 0, this.tileSize, this.tileSize, 0xff0000).setOrigin(0))
        this.body.push(this.scene.add.rectangle(this.tileSize * 1, 0, this.tileSize, this.tileSize, 0xffffff).setOrigin(0))
        this.body.push(this.scene.add.rectangle(this.tileSize * 0, 0, this.tileSize, this.tileSize, 0x0000ff).setOrigin(0))
        this.apple = this.scene.add.rectangle(64, 64, this.tileSize, this.tileSize, 0x00ff00).setOrigin(0);
        this.positionApple();
    ...
    move() {
        ...
        // Death by eating own tail - headpos === any of tail positions
